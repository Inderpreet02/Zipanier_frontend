    ...
    <div className='login__container'>
        <div className="login__wrapper">
            ...
            <form className="login__form">
                <input type="text" placeholder='name' className="login__input" onChange={(e) => setUsername(e.target.value)}/>
                <input type="text" placeholder='password' className="login__input"  onChange={(e) => setPassword(e.target.value)}/>
